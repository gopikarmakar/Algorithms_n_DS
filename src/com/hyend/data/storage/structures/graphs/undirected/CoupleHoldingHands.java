...
public class CoupleHoldingHands {
	...
	public static void main(String[] args) {
		...
		int swaps = minSwapCouples(row4);
		System.out.println("Minimum " + swaps + " Swaps Required");
	}
	
	/**
	 * Solution: Imagine it as a Di-Graph and map each person with the currently sitting seat. For e.g:  
	 ...
	 * 
	 * 0->0 2->1 3->2 4->3 5->4 1->5 6->6 8->7 7->8 9->9
	 * 
	 * So when we want to arrange the (0,1) couple and look for the 1st person. We go to the 5th seat 
	 * and swap them and update their seating position and keep doing so till the half of the couples.
	 * We finally meet the sitting adjacently arranged couple. Below is the implementation of same solution.    
	 *  
	 * O(N) time complexity.
	 */
